...
unsigned char *washing_prog[] = {"Daily", "Heavy", "Delicates", "Whites", "Stain wash", "EcoCottons", "Woolens", "Bed sheets", "Rinse+Dry", "Dry only", "Wash only", "Aqua store" };
...
void power_on_screen(void)
{
 ...
 void washing_program_display(unsigned char key)
 {
    ...
    if(program_no <= 9)
    {
    clcd_print( washing_prog[program_no], (0xC0 + 2));
    clcd_print( washing_prog[program_no + 1], (0x90 + 2));
    clcd_print( washing_prog[program_no + 2], (0xD0 + 2));
 }
 ...
 void water_level_display (unsigned char key)
 {
     ...
     {
        clcd_print(water_level_option[water_level_index], (0xC0 + 2));
        clcd_print(water_level_option[water_level_index + 1], (0x90 + 2));
        clcd_print(water_level_option[water_level_index + 2], (0xD0 + 2));
     }
     else if (water_level_index == 3)
     {
        clcd_print(water_level_option[water_level_index], (0xC0 + 2));
        clcd_print(water_level_option[water_level_index + 1], (0x90 + 2));
        clcd_print(water_level_option[0], (0xD0 + 2));
         }
     else if (water_level_index == 4)
     {
        clcd_print(water_level_option[water_level_index], (0xC0 + 2));
        clcd_print(water_level_option[0], (0x90 + 2));
        clcd_print(water_level_option[1], (0xD0 + 2));
         }
 }
 ...
 void run_program(unsigned char key)
     {
         ...
         if(reset_mode == 0x12)
         {
             ...
             clcd_print( washing_prog[program_no] , (0x80 + 6));
         ...
         if ((sec == 0) && (min == 0))
         {
             ...
             TMR2ON = 0;
              ...
              clcd_print("Wash Completed ", (0x80 + 0));
